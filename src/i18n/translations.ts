...
export const translations: Record<string, TranslationMap> = {
  zh: {
    ...
    // PDF Merge tool
    'pdfmerge.settings': '设置',
    'pdfmerge.dropLabel': '点击或拖拽上传 PDF 文件',
    'pdfmerge.files': '文件列表',
    'pdfmerge.pages': '页',
    'pdfmerge.merge': '合并',
    'pdfmerge.result': '合并结果',
    'pdfmerge.totalPages': '总页数',
    'pdfmerge.download': '下载合并后的 PDF',
    'pdfmerge.noFiles': '上传 PDF 文件开始合并',
    'pdfmerge.merging': '合并中...',
    'pdfmerge.totalFiles': '个文件',

    // PDF Split tool
    'pdfsplit.settings': '设置',
    'pdfsplit.dropLabel': '点击或拖拽上传 PDF 文件',
    'pdfsplit.fileInfo': '文件信息',
    'pdfsplit.pageCount': '总页数',
    'pdfsplit.mode': '拆分方式',
    'pdfsplit.byRange': '按页码范围',
    'pdfsplit.everyN': '每 N 页拆分',
    'pdfsplit.rangePlaceholder': '例如: 1-3, 5, 7-10',
    'pdfsplit.pagesPer': '每组页数',
    'pdfsplit.split': '拆分',
    'pdfsplit.result': '拆分结果',
    'pdfsplit.download': '下载',
    'pdfsplit.downloadAll': '下载全部',
    'pdfsplit.pages': '页',
    ...
    'imagetopdf.dropLabel': '点击或拖拽上传图片',
    'imagetopdf.images': '图片列表',
    'imagetopdf.orientation': '页面方向',
    'imagetopdf.portrait': '纵向',
    'imagetopdf.landscape': '横向',
    'imagetopdf.pageSize': '页面大小',
    'imagetopdf.generate': '生成 PDF',
    'imagetopdf.result': '生成结果',
    'imagetopdf.download': '下载 PDF',
    'imagetopdf.noImages': '上传图片开始生成',
    'imagetopdf.generating': '生成中...',

    // Image Compress tool
    'imagecompress.settings': '设置',
    'imagecompress.dropLabel': '点击或拖拽上传图片',
    'imagecompress.quality': '质量',
    'imagecompress.maxDimension': '最大宽高',
    'imagecompress.noLimit': '不限制',
    'imagecompress.format': '输出格式',
    'imagecompress.compress': '压缩',
    'imagecompress.result': '压缩结果',
    'imagecompress.original': '原始图片',
    ...
    'imageresize.dropLabel': '点击或拖拽上传图片',
    'imageresize.platform': '平台预设',
    'imageresize.custom': '自定义尺寸',
    'imageresize.width': '宽度',
    'imageresize.height': '高度',
    'imageresize.apply': '应用',
    'imageresize.result': '裁剪结果',
    'imageresize.outputSize': '输出尺寸',
    ...
    'pdf.marginLeft': '左',
    'pdf.marginRight': '右',
    'pdf.nativeHeaderFooter': '页眉、页脚和页码由浏览器打印设置控制（打印对话框中的「页眉和页脚」选项）。',
    'pdf.reset': '恢复默认',
    'pdf.preview': 'PDF 预览',
    'pdf.savePdf': '保存 PDF',
  ...
  en: {
    ...
    // PDF Merge tool
    'pdfmerge.settings': 'Settings',
    'pdfmerge.dropLabel': 'Click or drag to upload PDF files',
    'pdfmerge.files': 'File List',
    'pdfmerge.pages': 'pages',
    'pdfmerge.merge': 'Merge',
    'pdfmerge.result': 'Merge Result',
    'pdfmerge.totalPages': 'Total Pages',
    'pdfmerge.download': 'Download Merged PDF',
    'pdfmerge.noFiles': 'Upload PDF files to start merging',
    'pdfmerge.merging': 'Merging...',
    'pdfmerge.totalFiles': 'files',

    // PDF Split tool
    'pdfsplit.settings': 'Settings',
    'pdfsplit.dropLabel': 'Click or drag to upload a PDF file',
    'pdfsplit.fileInfo': 'File Info',
    'pdfsplit.pageCount': 'Total Pages',
    'pdfsplit.mode': 'Split Mode',
    'pdfsplit.byRange': 'By Page Range',
    'pdfsplit.everyN': 'Every N Pages',
    'pdfsplit.rangePlaceholder': 'e.g. 1-3, 5, 7-10',
    'pdfsplit.pagesPer': 'Pages per chunk',
    'pdfsplit.split': 'Split',
    'pdfsplit.result': 'Split Results',
    'pdfsplit.download': 'Download',
    'pdfsplit.downloadAll': 'Download All',
    ...
    'imagetopdf.dropLabel': 'Click or drag to upload images',
    'imagetopdf.images': 'Image List',
    ...
    'imagetopdf.generate': 'Generate PDF',
    'imagetopdf.result': 'Result',
    'imagetopdf.download': 'Download PDF',
    'imagetopdf.noImages': 'Upload images to start generating',
    'imagetopdf.generating': 'Generating...',

    // Image Compress tool
    'imagecompress.settings': 'Settings',
    'imagecompress.dropLabel': 'Click or drag to upload an image',
    'imagecompress.quality': 'Quality',
    'imagecompress.maxDimension': 'Max Dimension',
    'imagecompress.noLimit': 'No Limit',
    'imagecompress.format': 'Output Format',
    'imagecompress.compress': 'Compress',
    'imagecompress.result': 'Compression Result',
    ...
    'imageresize.dropLabel': 'Click or drag to upload an image',
    'imageresize.platform': 'Platform Presets',
    'imageresize.custom': 'Custom Size',
    'imageresize.width': 'Width',
    'imageresize.height': 'Height',
    'imageresize.apply': 'Apply',
    'imageresize.result': 'Resize Result',
    'imageresize.outputSize': 'Output Size',
    ...
    'pdf.nativeHeaderFooter': 'Headers, footers, and page numbers are controlled by the browser print settings (the "Headers and footers" option in the print dialog).',
